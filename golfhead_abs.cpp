...
int main()
{
	...
	//auto flag = set_operation_mode(device_id, 1);   // expert
	//cout << "set_operation_mode : " << flag << endl;
	set_override_ratio(device_id, 100.0); // %
	...
	// inter position    
	//double inter_point[6] = { -22.838, -5.137, -9.733, 0, -75.130, -22.738 };   // model9 //粗磨
	//double inter_point[6] = { 25.871, -5.137, -9.733, 0, -75.130, 29.807 };   // model9 //細磨
	double inter_point[6] = { -30.652, 3.732, -25.542, 0, -68.190, -120.329 }; //磨塊 粗磨1
